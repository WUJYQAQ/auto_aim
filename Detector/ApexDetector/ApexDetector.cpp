...
bool ApexDetector::detect(Mat &src, std::vector<ArmorObject>& objects)
{
    if (src.empty())
    {
...
void ApexDetector::display(Mat &image2show, ArmorObject object) {
    // 绘制十字瞄准线
